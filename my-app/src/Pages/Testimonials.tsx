    ...
    <div className="testimonial-container">
      ...
      <div className="testimonial-row">
        <div className="testimonial-column-full">
          ...
          <p>
            ...
            styling needs, and every experience has exceeded my expectations.
            Gio is the perfect balance of professionalism and personality—always
          ...
          <p>
            ...
            consistently made me feel like the best version of myself, and
            that’s a gift not every stylist can offer.
          </p>
          <p>
            I recommend Gio wholeheartedly—he’s not only talented and
            dependable, but also kind, approachable, and fairly priced. If
            you're looking for someone who truly cares about helping you feel
      ...
      <div className="testimonial-row">
        <div className="testimonial-column-full">
          ...
          <p>
            ...
            listens, and works with me on what im comfortable with, and
            considers my feedback. He makes me feel comfortable when working
            with him. It’s always fun working with him. And it doesn’t feel like
            it’s business, but more like a friend helping me. He’s always my
            go-to stylist.
          </p>
      ...
      <div className="testimonial-row">
        <div className="testimonial-column-full">
          ...
          <p>
            He is fun to work with, professional, and an artist of his craft.
            Gio is honest and keeps it real with me, which is why I love to work
            with him. If I don’t like how I feel in my clothes, we make
